...
cts<-AggregateExpression(RNA_seurat,
                    group.by=c("Fine_annotation_4_MNP_fibro_coarse","HS_combinebiopsy"),
                    assays = 'RNA',
                    slot = 'counts',
                    return.seurat = FALSE)
...
cts.split<-split.data.frame(cts.t,
                 f=factor(splitRows))
cts.split$`05_MNP_coarse`[1:10,1:10]
...
cts.split.modified$`05_MNP_coarse`[1:10,1:10]
#DE analysis in 05_MNP_coarse
counts_MNP<-cts.split.modified$`05_MNP_coarse`
...
#write to csv file
write.csv(res, file = "res_MNP.csv")
head(res)
```
